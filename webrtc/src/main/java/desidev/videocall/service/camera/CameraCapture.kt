...
import desidev.videocall.service.camera.CameraCapture.State
import desidev.videocall.service.codec.Codec
import desidev.videocall.service.codec.VideoEncoder
...
class CameraCaptureImpl(context: Context) : CameraCapture {
    ...
    private val _encoder: VideoEncoder = Codec.createVideoEncoder()
